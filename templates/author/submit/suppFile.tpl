...
<tr valign="top">
	...
	<td width="80%" class="value"><a href="{url op="download" path=$paperId|to_array:$suppFile->getFileId()}">{$suppFile->getOriginalFileName()|escape}</a></td>
</tr>
<tr valign="top">
...
<p><input type="submit" value="{translate key="common.saveAndContinue"}" class="btn btn-primary" /> <input type="button" value="{translate key="common.cancel"}" class="button" onclick="document.location.href='{url op="submit" path="4" paperId=$paperId}'" /></p>
