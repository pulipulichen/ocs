...
{else}
	{assign var="pageTitle" value="author.submit.step2AbstOnly"}
{/if}
...
<tr valign="top" class="hide">
	<td width="20%" class="label">{fieldLabel name="authors-$authorIndex-lastName" key="user.lastName"}</td>
...
<tr valign="top" class="hide">
	...
	<td width="80%" class="value">
		<input type="text" name="authors[{$authorIndex|escape}][affiliation]" class="textField" id="authors-{$authorIndex|escape}-affiliation" >{$author.affiliation|escape}</textarea>
	...
	<td width="80%" class="value">
		<select name="authors[{$authorIndex|escape}][country]" id="authors-{$authorIndex|escape}-country" class="selectMenu">
			...
			{*html_options options=$countries selected=$author.country*}
                        {html_options options=$countries selected="TW"}
		</select>
	</td>
</tr>
<tr valign="top">
	<td width="20%" class="label">
            ...
            <!-- <br />{translate key="user.biography.description"}-->
        </td>
