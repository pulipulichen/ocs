...
<p class="text-center">
    <input type="submit" value="{translate key="common.continue"}" class="btn btn-primary" /> 
    <input type="button" class="btn btn-default" onclick="history.go(-1)" value="{translate key="common.cancel"}" /></p>
</form>
