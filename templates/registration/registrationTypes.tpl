...
<ul class="nav nav-tabs">
	...
	<li class="current active"><a href="{url op="registrationTypes" clearPageContext=1}">{translate key="manager.registrationTypes"}</a></li>
...
<table width="100%" class="listing">
	...
	<tr class="heading" valign="bottom">
		<td>{translate key="manager.registrationTypes.name"}</td>
		<td>{translate key="manager.registrationTypes.cost"}</td>
