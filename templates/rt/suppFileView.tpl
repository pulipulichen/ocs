...
{if $suppFile}
	<tr valign="top">
		...
		<td width="80%" class="value"><a href="{url page="paper" op="downloadSuppFile" path=$paperId|to_array:$suppFile->getBestSuppFileId($currentConference)}">{$suppFile->getOriginalFileName()|escape}</a></td>
	</tr>
	<tr valign="top">
