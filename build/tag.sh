...
echo "4. GitHub New Release Again:  https://github.com/${GITHUB_USER}/${GITHUB_REPO}/releases/new"
echo "5. GitHub Homepage:  ${GITHUB_HOMEPAGE}"

if [ -n "$DOI" ]; then
  echo "6. Zenono Public:  https://doi.org/${DOI}"
fi
echo "================================================"